...
from app.api.routes_parent_controls import router as parent_controls_router
...
api_router.include_router(parent_controls_router, prefix="/api", tags=["parent-controls"])
